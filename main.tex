...
%% Comment it out when using e.g. vim-latex and use the command below

% bibresource moved here for vim-latex
...
%% general metadata:
\newcommand{\myauthor}{Zippy the Bug}  %% also used for PDF metadata (hyperref)
\newcommand{\myauthorwithexistingtitles}{\myauthor{}, Novice}  %% including
                                %% university degree already held
                                %% (BSc, MSc, ...)
\newcommand{\mytitle}{Towards Secure Systems}  %% also used for PDF metadata (hyperref)
\newcommand{\mysubtitle}{hack.more.systems to find.more.bugs}  %% only used with title_Thesis_TU_Graz_-_kazemakase
\newcommand{\mysubject}{Towards Secure Systems}  %% also used for PDF metadata (hyperref)
\newcommand{\mykeywords}{IT security, white hat, hacking, bug, fuzzy}  %% also used for PDF metadata (hyperref)
...
\newcommand{\mystudy}{Computer Science} %% your study like ``Arts'', ``Information and Computer Engineering'' etc.
\newcommand{\mydegreeprogramme}{Master's degree programme: \mystudy} %% Master's or PhD degree programme
\newcommand{\myuniversity}{Graz University of Technology} %% your university/school
\newcommand{\myfaculty}{Faculty of Bug Hunting}  %% only used with title_Thesis_TU_Graz_-_kazemakase
\newcommand{\myinstitute}{Institute for White Hat Hacking} %% affiliation
\newcommand{\myinstitutehead}{Univ.-Prof.\,Dipl-Ing.\,Dr.techn.~Fuzzy the Bug, Emperor} %% head of institute
\newcommand{\mysupervisor}{Dr.~Some Bug} %% your supervisor
